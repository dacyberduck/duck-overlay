...
inherit vim-doc flag-o-matic bash-completion-r1 lua-single python-single-r1 ruby-single desktop xdg-utils toolchain-funcs
...
LICENSE="vim"
SLOT="0"
IUSE="X acl crypt cscope debug gpm +lto lua minimal nls perl python racket ruby selinux sound tcl terminal vim-pager"
REQUIRED_USE="
...
src_configure() {
	...
	# LTO
	if use lto ; then
		tc-is-clang && append-flags -flto=thin || append-flags -flto
	fi
